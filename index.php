			...
			<div class="col-sm-15">
				<div class="card text-left">
					<div class="card-header">
						<h2><center>NOVEDADES DE KONAMI</center></h2>
					</div>
					<div class="card-body">
						<span class="btn btn-primary" data-toggle="modal" data-target="#agregarnuevosdatosmodal">
							Agregar nuevo <span class="fas fa-gamepad"></span>
						</span>
						<hr>
...
<script type="text/javascript">
	function agregaFrmActualizar(idjuego){
		$.ajax({
			...
			success:function(r){
				...
				$('#idjuego').val(datos['id_videojuegos']);
	...
	function eliminarDatos(idjuego){
		alertify.confirm('Eliminar un juego', '¿Desea eliminar este registro?', function(){ 
